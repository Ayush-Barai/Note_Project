<header class="bg-gray-900">
    <nav aria-label="Global" class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
            ...
            <?php else :?>
                <a href="/login" class="text-sm/6 font-semibold text-white mx-4">Log In</a>
            ...
            <div tabindex="0" class="fixed inset-0 focus:outline-none">
                ...
                <div class="mt-6 flow-root">
                    ...
                    <div class="space-y-2 py-6">
                        ...
                        <?php if($_SESSION['user'] == false):?> 
                            <a href="/notes" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Notes</a>
                        <?php endif;?>    
                        <a href="/contact" class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-white hover:bg-white/5">Contact</a>
                    </div>
                    <div class="py-6">
                        <a href="/register" class="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-white/5">Sign Up</a>
                    </div>
                    </div>
                </div>
                </el-dialog-panel>
